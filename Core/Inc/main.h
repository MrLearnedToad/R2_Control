...
/* Private defines -----------------------------------------------------------*/
#define Cylinder1_Pin GPIO_PIN_3
#define Cylinder1_GPIO_Port GPIOE
#define Cylinder2_Pin GPIO_PIN_13
#define Cylinder2_GPIO_Port GPIOC
#define Cylinder3_Pin GPIO_PIN_14
#define Cylinder3_GPIO_Port GPIOC
#define Cylinder4_Pin GPIO_PIN_15
#define Cylinder4_GPIO_Port GPIOC
